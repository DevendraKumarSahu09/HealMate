            ...
            <div>
              <div className='lg:w-[570px]'>
                ...
                <p className="text__para">
                  Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consequuntur, numquam odit similique voluptates temporibus corporis animi sequi itaque, quo explicabo quisquam non, perspiciatis omnis impedit? Quia laudantium architecto impedit nemo.
                </p>
            ...
            <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
              ...
              <div className="w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
                ...
                <div className="flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]">
                  ...
                  <h4 className='text-[10px] leading-3 lg:text-[16px] lg:leading-[22px] fonr-[700] text-headingColor'>
                    Wayne Collins
                  </h4>
                </div>
              </div>
